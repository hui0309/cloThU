	...
	<div class="container-fluid m-1" style="position: absolute; top:0px;">
		...
		<a class="nav-link active" aria-current="page" href="#">Active</a>
		  ...
		  <li><a class="dropdown-item" href="#">Separated link</a></li> -->
			...
			<div class="row d-flex align-items-around justify-content-center infoBack">
				<div class="col-1 col-sm-1 col-md-2"></div>
				<div class="row col-10 col-sm-10 col-md-8 ">
					<div class="row infoCard justify-content-center">
						<div class="col  align-items-center align-self-center justify-content-center">
							<div class="row d-flex align-items-center align-self-center justify-content-center">
								<input class=" d-flex align-items-center align-self-center img-fluid" type="image"
									id="img" name="img" style="max-width:25rem;" readonly />
							</div>
							<div class="col">
								<div class="row d-flex align-items-center mb-2 justify-content-center m-2">
									<div
										class="col-6 d-flex align-items-center align-self-center justify-content-center">
										<div class=" d-flex align-items-center ">
											<form method="post" action="session_init.php">
												<button class="btn btn btn-outline-secondary text-nowrap " type="button"
													id="edit" value="編輯">
													編輯
												</button>
											</form>
										...
										<div
											class="col-6 d-flex align-items-center align-self-center justify-content-center">
											<form method="post" action="session_init.php">
												<button class="btn btn btn-danger text-nowrap" type="submit" id="target"
													name="target" value="登出">
													登出
												</button>
											</form>
										</div>
							...
							<div class="row d-flex align-items-center justify-content-between">
								...
								<div class="row ">
									...
									<div class="col-8 col-sm-7 d-flex align-items-center justify-content-between"
										...
										<h5 type="text" id="user_mail" readonly style="white-space: initial;">
										</h5>
									</div>
								</div>
								<div class="row ">
				...
				<!-- <div
				clas="row col-10 col-sm-10 col-md-8 d-flex align-items-center align-self-center justify-content-center ">
				<div class="row infoCard justify-content-center">
					<div
						class="row col-6 col-sm-6 col-md-5 d-flex align-items-center align-self-center justify-content-center">
						<div class="row d-flex align-items-center align-self-center justify-content-center">
