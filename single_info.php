...
<body>
    <div class="container-fluid m-1">
        ...
        <div class="row d-flex align-items-center justify-content-center">
            ...
            <div class="row col-6 col-sm-4 col-md-3 d-flex align-items-center justify-content-between">
                ...
                <div class="row  d-flex align-items-center m-1 justify-content-between">
                    <div class="row ">
                        <div class="col-4 col-sm-6 d-flex align-items-center justify-content-between">
                            <h5 class="text-nowrap"><strong>分類 </strong></h4>
                        </div>
                        <div class="col-8 col-sm-6 d-flex align-items-center justify-content-between">
        ...
        <div class="menu">
            <a href="single.php">
                <div style="text-align:right;padding-top:10px; color:black; ">離開</div>
            </a>
        ...
        <div>
            <form id="mfrom" method="post" action="single_update.php">
                <td>
                    <div style="text-align:right; padding-top:75%; "> <input type="submit" class="button" onclick=""
                            value="修改"></div>
                </td>
                <td>
                    <div style="text-align:right; padding-top:75%; "> <input type="hidden" id="cloth_id" name="cloth_id"
                            value="<?php echo $cloth_id ?>"></div>
                </td>
            </form>
        </div>
    </div>
